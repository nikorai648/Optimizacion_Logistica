...
class EficienciaTrabajador(models.Model):
    # ← CAMBIO: ahora anulable temporalmente
    trabajador = models.ForeignKey(Trabajador, on_delete=models.CASCADE,
                                   related_name='eficiencias', null=True, blank=True)
...
class DesempenoTrabajador(models.Model):
    # ← CAMBIO: ahora anulable temporalmente
    trabajador = models.ForeignKey(Trabajador, on_delete=models.CASCADE,
                                   related_name='desempenos', null=True, blank=True)
...
class SueldoTrabajador(models.Model):
    # ← CAMBIO: ahora anulable temporalmente
    trabajador = models.ForeignKey(Trabajador, on_delete=models.CASCADE,
                                   related_name='sueldos', null=True, blank=True)
